...
bot = telebot.TeleBot('7413851330:AAE2PzaiPNnZ_O1DrwkyId-q2MCGbZzuMws')
currency = CurrencyConverter()
amount = 0

@bot.message_handler(commands=['start'])
def start(message):
        bot.send_message(message.chat.id, 'Привет! Я помогу узнать актуальные курсы валют, криптовалют. Для начала напишите сумму:')
